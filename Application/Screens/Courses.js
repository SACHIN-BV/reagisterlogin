...
import { Container, Button, Tab, Tabs, ScrollableTab, DeckSwiper, Header, Card, CardItem, Body, Content, H1, H2, H3, Text, Thumbnail, Left,  } from 'native-base';
...
export default class Courses1 extends Component {
  constructor(props){
    super(props);
    this.state={
      avatarSource: null,
  ...
  onSubmit = (id,User) =>{
    fetch('https://sachinbv96.000webhostapp.com/react/subscribe.php', {
      method: 'post',
      header:{
        'Accept': 'application/json',
        'Content-type': 'application/json'
           ...
           <View style={{flex:1}}>
              ...
              <ImageBackground source={require('../Images/1.jpg')} style={{
                ...
                <View style={{
                  ...
                  <Text style={[styles.textStyle, { backgroundColor: 'transparent', marginTop: 20,marginBottom:10}]}>{item.cname}</Text>
                  <StarRating
                        disable={true}
                        maxStars={5}
                        rating={4}
                 ...
                 <Button primary style={ { marginTop: 20}} onPress={this.onSubmit.bind(this,item.id,this.state.user_id)}><Text> SubScribe </Text></Button>
